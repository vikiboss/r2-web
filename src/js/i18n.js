...
const I18N = {
  zh: {
    ...
    setPasswordPlaceholder: '输入密码',
    setPasswordConfirm: '确认密码',
    setPasswordBtn: '设置并保存',
    passwordMismatch: '两次输入的密码不一致',
    passwordEmpty: '密码不能为空',
    migratePasswordTitle: '为保护配置安全，请设置密码',
    migratePasswordDesc: '配置将加密存储，之后每次打开需输入密码解锁。',
  ...
  en: {
    ...
    setPasswordBtn: 'Set and save',
    passwordMismatch: 'Passwords do not match',
    passwordEmpty: 'Password cannot be empty',
    migratePasswordTitle: 'Set a password to protect your config',
    migratePasswordDesc: 'Config will be stored encrypted. You will need to enter the password each time you open the app.',
  ...
  ja: {
    ...
    unlockTitle: 'パスワードを入力してロック解除',
    unlockPlaceholder: 'パスワード',
    unlockBtn: 'ロック解除',
    unlockFailed: 'パスワードが正しくありません',
    setPasswordTitle: 'パスワードを設定',
    setPasswordPlaceholder: 'パスワードを入力',
    setPasswordConfirm: 'パスワードを確認',
    setPasswordBtn: '設定して保存',
    passwordMismatch: 'パスワードが一致しません',
    passwordEmpty: 'パスワードを入力してください',
    migratePasswordTitle: '設定を保護するためパスワードを設定してください',
    migratePasswordDesc: '設定は暗号化して保存されます。次回起動時にパスワードが必要です。',
